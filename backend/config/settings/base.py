"""
Base settings for ThePaper Graph project.
"""
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "thepaper_graph"),
...
CRAWL_REQUEST_DELAY = float(os.environ.get("CRAWL_REQUEST_DELAY", "1.0"))
